...
export const coreConditions: Condition[] = [
  ...
  },
  {
    ...
    pearl: '脳神経：性別を問わず起こる。最悪頭痛・神経脱落があれば二次性頭痛を除外するまで片頭痛と決めない。',
  ...
  },
  {
    id: 'uti',
    name: '尿路感染症（膀胱炎など）',
    summary: '排尿時痛・頻尿・残尿感が典型。女性に多いが、男性では複雑性として早めの評価が望ましい。',
    pearl: '泌尿器：男性の初回UTIは複雑性として精査。発熱・側腹部痛があれば腎盂腎炎を疑う。',
    symptoms: ['urinary_pain', 'frequent_urination', 'abdominal_pain', 'fever'],
    urgency: 'soon',
    homeCare: ['水分を十分にとる', '我慢せず排尿する', '陰部を清潔に保つ'],
    seeDoctorWhen: ['発熱・腰痛を伴う（腎盂腎炎の可能性）', '血尿', '妊娠中', '男性で初めての症状'],
  },
  {
    id: 'angina_acs',
    name: '狭心症・急性冠症候群の疑い',
  ...
  },
  {
    id: 'anemia_suspect',
    name: '貧血の疑い',
    summary: 'だるさ・動悸・めまい・顔色不良などがみられる。鉄欠乏・出血・慢性疾患など原因は多様。',
    pearl: '内科：性別を問わず評価。男性・閉経後の鉄欠乏は消化管出血などの隠れた原因検索が重要。',
  ...
  },
  {
    ...
    name: '魚の目（鶏眼）・胼胝（たこ）',
    summary:
      '足の裏や指の間などに、圧迫・摩擦で硬く厚くなった皮膚ができる。中心が芯のように硬く、歩くと痛むことが多い。',
    pearl:
      '皮膚科：魚の目は中心に核があり圧痛が強い。いぼ（ウイルス性）との鑑別が重要。靴のフィット・歩行フォームも原因評価に含める。糖尿病足では自己処置を避ける。',
    symptoms: ['rash'],
    urgency: 'home',
    homeCare: [
      '合わない靴・きつい靴を避ける',
      '保湿し、無理に削らない・市販の強酸は用法を守る',
      '清潔を保ち、出血や化膿があれば中止して受診',
    ],
    seeDoctorWhen: [
      '痛みで歩行がつらい',
      '糖尿病・血流障害がある',
